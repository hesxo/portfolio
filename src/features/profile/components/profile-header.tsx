...
export function ProfileHeader() {
  return (
    <div suppressHydrationWarning={true} className="screen-line-after flex border-x border-edge">
      <div className="shrink-0 border-r border-edge pr-3 max-sm:pr-2">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <div className="border-t border-edge">
          <h1 className="flex flex-row flex-wrap items-center pl-4 pr-2 text-xl sm:text-3xl font-semibold w-full gap-2 leading-tight py-2">
